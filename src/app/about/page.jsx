      ...
      <div className={styles.textContainer}>
            <div className={styles.item}>
                ...
                <p className={styles.decs}>
                  To dream about a funeral will usually mean something new and fresh is about to start in your life
                </p>
            </div>
            <div className={styles.item}>
            <h1 className={styles.title}>What we do?</h1>
            <p className={styles.decs}>Since the beginning of the year, violence in the autonomous region has left more than 400 people dead, including police.</p>
            <br />
            <br /> - Dynamic Websites
            <br />
            <br /> - Fast and Handy
